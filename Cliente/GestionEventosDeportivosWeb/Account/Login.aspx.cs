...
using Owin;
using GestionEventosDeportivosWeb.Models;
using System.Net;
using System.Text;

namespace GestionEventosDeportivosWeb.Account
{
    public partial class Login : Page
    {
        ...
        protected void LogIn(object sender, EventArgs e)
        {
            if (IsValid)
            {
                ...
                var result = signinManager.PasswordSignIn(Usuario.Text, Password.Text, RememberMe.Checked, shouldLockout: false);
                //Validar 
                //var authenticate = new WebClient().DownloadString("http://localhost:49220/api/login/authenticate?Username=user&Password=123456");
